...
if args.skip_connections:
    netG = Generator_alt(state_dim, latent_dim, state_dim, batch_norm=args.batch_norm, hidden_sizes=hidden_sizes_G).to(device)
    netD = Discriminator_alt(state_dim, spectral_norm=args.spectral_norm, hidden_sizes=hidden_sizes_D).to(device)
else:
    netG = Generator(state_dim, latent_dim, state_dim, batch_norm=args.batch_norm, hidden_sizes=hidden_sizes_G).to(device)
    netD = Discriminator(state_dim, spectral_norm=args.spectral_norm, hidden_sizes=hidden_sizes_D).to(device)
